...
#include "DialogueAction_GrantUppercutAbility.h"
...
void UDialogueAction_GrantUppercutAbility::ExecuteAction(const UWorld* WorldContext)
{
	...
	EnhancedInputComponent->BindAction( UppercutAction, ETriggerEvent::Started, PlayerCharacter, &ANCCharacter_Player::Uppercut );
}
