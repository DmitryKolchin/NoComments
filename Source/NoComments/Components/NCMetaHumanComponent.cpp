...
#include "NCMetaHumanComponent.h"
...
void UNCMetaHumanComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UNCMetaHumanComponent::SetupCustomizableBodyPart(FMetaHumanCustomizableBodyPart& BodyPart)
{
...
void UNCMetaHumanComponent::PostInitAnimBP(USkeletalMeshComponent* SkeletalMeshComponent, UAnimInstance* AnimInstance) const
{
	if (!AnimInstance)
	{
		return;
